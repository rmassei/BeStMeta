...
_Video acquisition and recording parameters, including timing encoding and illumination details._
...
URI: [BeStMeta:Acquisition](https://w3id.org/BeStMeta/Acquisition)
...
```mermaid
 classDiagram
    ...
    click Acquisition href "../Acquisition/"
      ...
      Acquisition : color_mode
        
          
    
        
        
        Acquisition --> "0..1" ColorModeEnum : color_mode
      ...
      Acquisition : frame_rate
        
      Acquisition : gain
        
      Acquisition : illumination_illuminance
        
      Acquisition : illumination_type
        
          
    
        
        
        Acquisition --> "0..1 _recommended_" IlluminationTypeEnum : illumination_type
        click IlluminationTypeEnum href "../IlluminationTypeEnum/"
    

        
      Acquisition : illumination_wavelength
        
      Acquisition : noise_reduction_method
        
      Acquisition : recording_duration
        
      Acquisition : recording_end_datetime
        
      Acquisition : recording_software_name
        
      Acquisition : recording_software_version
        
      Acquisition : recording_start_datetime
        
      Acquisition : spatial_resolution
        
      Acquisition : total_frame_count
        
      Acquisition : video_codec
        
          
    
        
        
        Acquisition --> "0..1 _recommended_" VideoCodecEnum : video_codec
        click VideoCodecEnum href "../VideoCodecEnum/"
    

        
      Acquisition : video_container_format
        
          
    
        
        
        Acquisition --> "1" VideoContainerEnum : video_container_format
        click VideoContainerEnum href "../VideoContainerEnum/"
    

        
      Acquisition : video_resolution_height
        
      Acquisition : video_resolution_width
...
| ---  | --- | --- | --- |
| [HardwareandAcquisition](HardwareandAcquisition.md) | [acquisition](acquisition.md) | range | [Acquisition](Acquisition.md) |
...
| ---  | ---  |
| self | BeStMeta:Acquisition |
| native | BeStMeta:Acquisition |
...
```yaml
name: Acquisition
description: Video acquisition and recording parameters, including timing encoding
